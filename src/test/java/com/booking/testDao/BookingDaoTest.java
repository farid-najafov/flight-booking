...
public class BookingDaoTest {
    private BookingDAO bookingDAO = new BookingDAO("bookingDaoTest.txt");
    ...
    public void createFile() {
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("bookingDaoTest.txt")))) {
    ...
    public void testGetAll() {
        ...
        readyBookings= (List<Booking>) bookingDAO.getAll();
    ...
    public void testGet() {
        int id = 32;
        assertEquals(Optional.of(b1), bookingDAO.get(id));
    }
    ...
    public void testGetAllBy() {
        ...
        booking.add(b2);
        assertEquals(booking, bookingDAO.getAllBy(f -> f.getPassengers().get(0).getFirstName().equals("Farid")));
    }
    ...
    public void testCreate() {
        ...
        List<Booking> readyBookings = (List<Booking>) bookingDAO.getAll();
