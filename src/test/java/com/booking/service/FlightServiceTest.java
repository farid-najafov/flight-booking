...
class FlightServiceTest {
    private FlightService flightService = new FlightService("flightServiceTest.txt");
    ...
    public void createFile(){
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("flightServiceTest.txt")))) {
    ...
    public void testGetAll() {
        ...
        readFlights = (List<Flight>) flightService.getAll();
    ...
    public void testGet() {
        int id = 32;
        assertEquals(Optional.of(f1), flightService.get(id));
    }

    @Test
    public void testCreate() {
        flightService.create(f3);
        readFlights = (List<Flight>) flightService.getAll();
    ...
    public void testGetAllBy() {
        ...
        flight.add(f2);
        assertEquals(flight, flightService.getAllBy(f -> f.getDestination().name().equals("OSLO")));
    }
