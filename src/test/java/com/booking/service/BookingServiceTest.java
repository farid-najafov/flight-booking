...
class BookingServiceTest {
    ...
    public void createFile() {
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("bookingServiceTest.txt")))) {
    ...
    public void testGetAll() {
        ...
        readyBookings= (List<Booking>) bookingService.getAll();
    ...
    public void testGet() {
        int id = 32;
        assertEquals(Optional.of(b1), bookingService.get(id));
    }
    ...
    public void testGetAllBy() {
        ...
        booking.add(b2);
        assertEquals(booking, bookingService.getAllBy(f -> f.getPassengers().get(0).getFirstName().equals("Farid")));
    }
    ...
    public void testCreate() {
        ...
        List<Booking> readyBookings = (List<Booking>) bookingService.getAll();
